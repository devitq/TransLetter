...
class FileValidator(object):
    error_messages = {
        "max_size": _(
            "Ensure this file size is not greater than"
            " %(max_size)s. Your file size is %(size)s.",
        ),
        "min_size": _(
            "Ensure this file size is not less "
            "than %(min_size)s. Your file size is %(size)s.",
        ),
...
validate_translation_file = FileValidator(max_size=1 * 1024 * 1024)
